...
int main() {
    ...
    string dst_dir = "D:/projects/20260525chongying/imgs_infer/mblyy";

    // 初始化重影移除器及其内部 YOLO 模型。
    GhostRemover remover;
    std::cout << "Initializing YOLO detector..." << std::endl;
    if (!remover.initialize("D:/projects/20260525chongying/models/20260702_best_ncnn_model/model.ncnn.param.enc", "D:/projects/20260525chongying/models/20260702_best_ncnn_model/model.ncnn.bin.enc", false)) {
