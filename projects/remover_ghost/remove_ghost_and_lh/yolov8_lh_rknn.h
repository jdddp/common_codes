#ifndef YOLOV8_LH_RKNN_H
#define YOLOV8_LH_RKNN_H
...
#ifndef YOLO_LH_DETECT_OBJECT_DEFINED
#define YOLO_LH_DETECT_OBJECT_DEFINED
struct Object_LH
{
    // 还原到原图坐标系中的检测框。
    cv::Rect_<float> rect;
...
public:
    ...
    std::vector<Object_LH> detect(const cv::Mat& img);
